// At this lesson, we will learn some methods about add / remove array elements.
// They are: push(), pop(), shift() and unshift().
...
// These four methods are the most basic methods of adding and removing elements.
// We can choose to use them according to their needs.

// Of course, their shortcomings are obvious.
// First, they can only manipulate the head and tail of the array, not flexible enough.
// Secondly, their speed is relatively slow.But we usually don't feel it,
// when you need to deal with big data, you will understand what is slow.
// For example, in some cases, the direct assignment of the array elements will be faster than the push method:
