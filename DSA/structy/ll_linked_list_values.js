...
// an argument. The function should return an array containing all values of 
// the nodes in the linked list.

// Hey. This is our first linked list problem, so you should be liberal with 
// watching the Approach and Walkthrough. Be productive! -AZ
...
// recursive way to solve the task
const linkedListValues = (head) => {
    const values = [];
