// In this lesson we learn about log() and its family: methods log10(), log2(), log1p(),
// constants LN2, LN10, LOG2E, LOG10E.They are the different calculation methods of natural logarithm.
...
// (because my MATH is poor, so there is not too many examples):
...
// In fact, log1p(x) equals to log(1 + x).
// log() is very useful when we need to calculate the increment or decrement.
...
// You need to look at the test cases.
// Thinking and testing.
// solve this kata by yourself; -)
