// In this lesson we learn three methods of Math: pow() sqrt() and cbrt().
...
// The second parameters of the pow() can be used as a fractional or decimal fraction,
// thus getting the same results as sqrt() and cbrt(). See example:
...
// Look at the example above, what's the problem?
// Yes, the cube root of 64 should be 4, but we have not seen the 4,
// but see 3.9999999999999996.
// Due to the numerical precision of JS, the error will be produced
// in the calculation.This is a problem that can't be avoided.
...
// This function is used to verify whether n is the cube root of m.
// It is obvious that the result is wrong.We should verify like this:
...
// The following three methods are used to verify that
// the square root of a number is an integer:
...
// function accept 2 parameter: volume and n.volume is the volume of a cube.
// If we cut the cube into n block.please determine whether the length of
// the cube is an integer.return true or false.
