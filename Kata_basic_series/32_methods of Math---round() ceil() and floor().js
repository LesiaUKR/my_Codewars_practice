// From this lesson, we learn about JS static object: Math.
// It mainly helps us to carry out mathematical calculations.
// It has a lot of properties and methods.Some of the properties
// and methods we rarely used.So we only learn some common methods.

// The properties of the Math object are some constants, such as PI,
// on behalf of the approximate value of pi.The usage is Math.PI.

// Math Object - The Math namespace object contains static properties and methods
...
// In this lesson we learn three methods to turn a number into an integer:
...
// Math.ceil() - static method always rounds up and returns the smallest integer
// greater than or equal to a given number
// Math.floor() - static method always rounds down and returns the largest
// integer less than or equal to a given number.

// First of all, we have to understand the first thing,
// all the methods of the Math object are static methods.
// It means that you need to use the Math method like this:
// Math.round(1.23). Not like this: (1.23).round().
...
// We can see,
// ceil() always rounding up to get a large integer;
// floor() always rounding down to get a small integer;
// round() according to the fractional part and round it to integer.
...
// It should be noted that they are not working on the fractional part.
// If you want to keep two decimal places or otherwise,
// you should use Methods of Number object--toFixed(), toExponential() and toPrecision(),
// or use the following techniques:
...
// In the example above, we first multiply the number by 100,
// and then round it. the final result is to retain two decimal places.
