...
// As you see, there are three parts in the parentheses, separated by ";".
// The first part, var sum = 0, num = 1, is the initialization.
// This part will run before the loop starts.The second part,
// num<= 100 is the conditional expression.The conditional expression
// is checked before the start of each time through the loop.
// When the value of the expression is false, the loop will be terminated.
// The third part, num++ will run after the code block, and is usually
// used for increasing and decreasing variables.
