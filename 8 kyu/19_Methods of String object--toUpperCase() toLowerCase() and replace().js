// This time we learn three string methods used
// to change the contents of the string: toUpperCase() toLowerCase() and replace().
// Their usage:
...
// toUpperCase() and toLowerCase() usage is very simple.
// No parameters needs accept.
...
// The following is a classic usage.
...
// Let's learn new method to improve it.
...
//output:
// This Is An Example.
// If the parameter 1 of replace() is a regular expression,
// it will be more simple(We don't even need to split the string):
...
// and all the characters that match the regular expression are replaced
// (The regular expression uses a global matching option g).
// If we use a string as a parameter 1, only the first match(from left to right) of the string is replaced.
// like this:
...
// Coding in function alienLanguage, function accept 1 parameter: str.
// str is a sentence.
