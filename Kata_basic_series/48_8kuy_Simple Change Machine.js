...
// This change machine is programmed to accept and distribute strings
// rather than numbers.The change will be returned as one string with
// the change separated by single spaces & no commas.
// The values of the string will be descending.

function changeMe(moneyIn) {}
// Test the function
console.log(changeMe("£3"));
